...
<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">马拉松赛事信息发布系统</h2>
</div>
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="get_cpacha?vl=4&w=152&h=40"></div>
      </div>
...
<div class="footer">Copyright &nbsp; 2020 @ Tangyh </div>
