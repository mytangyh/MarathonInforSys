	...
	<div id="addDialog" style="padding: 10px;">
		<form id="addForm" method="post">
			<table id="addTable" cellpadding="8">
				<tr>
                    <td>时间：</td>
                    <td><input class="easyui-datetimebox" name="notice_time"
                        id="add_noticetime" data-options="required:true,showSeconds:false"
                        value="${notices.release_time}" style="width: 200px"></td>
                </tr>
				<tr>
					<td>公告:</td>
					<td><input id="add_noticetext" class="easyui-textbox"
						style="width: 200px; height: 150px;" type="text" name="notice_text"
						data-options="multiline:true,required:true, missingMessage:'请填写公告内容'" /></td>
				</tr>
